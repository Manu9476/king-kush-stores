...
class AdvertisingCampaignAdmin(admin.ModelAdmin):
    list_display = ("id", "title", "purpose", "placement", "source_type", "status", "priority", "impression_count", "click_count")
    list_filter = ("status", "purpose", "source_type", "placement", "is_visible", "is_sponsored")
